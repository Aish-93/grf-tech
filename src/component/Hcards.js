...
return (
    <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 p-4 ">
      {Hcard.map((item, index) => (
        ...
        >
          <img
            className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-t-lg group-hover:opacity-90 transition-opacity duration-300"
            src={item.image}
            alt=""
          />
