...
const features = [
  {
    ...
    icon: () => <FontAwesomeIcon icon={faHtml5} size='2xl' color='#F0DB4F' />,
  },
  {
    name: 'CSS',
    description:
    ...
    icon: () => <FontAwesomeIcon icon={faCss3} size='2xl' color='green' />,
  },
  {
    name: 'React.js',
    description:
    ...
    <div className='bg-white py-24 sm:py-32'>
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        <div className='mx-auto max-w-2xl lg:text-center'>
          ...
          <p>
            Are you ready to embark on a journey to mastering the world of
            coding? Our platform offers a comprehensive and engaging experience
            tailored for learners of all levels. Whether you’re a complete
