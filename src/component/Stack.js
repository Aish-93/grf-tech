...
export default function Stack() {
  return (
    <form className='enroll-form mt-5 mx-auto'>
      <div className=' space-y-12'>
        {/* <div className='border-b border-gray-900/10 pb-12'>
          <h2 className='text-4xl font-semibold text-gray-900 pt-2'>
            Enrollment Form
          </h2>
        ...
        <div className='border-b border-gray-900/10 pb-12'>
          <h2 className='text-3xl pt-4 font-semibold text-gray-900'>
            Enrollment Form
          </h2>
          <p className='mt-1 text-sm/6 text-gray-600'>
            Fill the form showing below
          </p>

          <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 w-full'>
            <div className='d-flex justify-around' style={{ width: '80vw' }}>
              <div>
