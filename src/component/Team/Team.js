    ...
    <div>
      ...
      <div className='team-container d-flex'>
        ...
        <div className='team-card mt-5'>
          ...
          />
          <div className='mt-2'>
            <p className='teammates-name'>Aishwary Saxena</p>
            <p className='team-designation'>Co-founder</p>
          </div>
        </div>
        <div className='team-card mt-5'>
          <img
            className='team-img mx-3'
            src='https://img.freepik.com/premium-photo/business-woman-office-portrait-arms-crossed-lawyer-employee-law-firm-vision-company-worker-female-person-with-confidence-proud-from-professional-attorney-job-work-success_590464-189532.jpg'
            alt=''
          />
          <div className='mt-2'>
            <p className='teammates-name'>Aakrti Khatarkar</p>
            <p className='team-designation'>Mentor</p>
          </div>
        </div>
        <div className='team-card mt-5'>
          <img
            className='team-img mx-3'
            src='https://www.shutterstock.com/image-photo/headshot-portrait-smiling-young-caucasian-260nw-1916405282.jpg'
            alt=''
          />
          <div className='mt-2'>
            <p className='teammates-name'>Amit Singh Chouhan</p>
            <p className='team-designation'>Mentor</p>
          </div>
        </div>
      </div>
