          ...
          <Accordion className='faq-acc mt-5' flush>
            <Accordion.Item eventKey='0'>
              ...
              <Accordion.Body className='text-start'>
                ...
                help you build a strong foundation before moving on to more
                complex concepts.
              </Accordion.Body>
            </Accordion.Item>
            ...
            <Accordion.Item eventKey='2' className='mt-3'>
              ...
              <Accordion.Body className='text-start'>
                ...
                designed for learners from various educational backgrounds.
                Whether you’re new to tech or looking to upskill, we provide the
                foundational knowledge and support needed to help you succeed in
                the field.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey='3' className='mt-3'>
              ...
              <Accordion.Body className='text-start'>
                Yes, we offer dedicated support for mock interviews. Our mentors
                and career coaches will conduct practice interviews to help you
                prepare for real-world situations and enhance your performance.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey='4' className='mt-3'>
              ...
              <Accordion.Body className='text-start'>
                Upon successfully completing a course at Graphene Infotech,
                you’ll receive a certificate that verifies your newly gained
                skills. This certificate is a valuable asset to enhance your
                resume and LinkedIn profile, highlighting your expertise.
              </Accordion.Body>
            </Accordion.Item>
          </Accordion>
        </div>
